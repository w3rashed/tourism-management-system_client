      ...
      <div className="text-center w-[70%] mx-auto">
        ...
        <Zoom duration="1000" delay="90">
          <p className="mt-4 mb-10 opacity-80">
            Experience the essence of our adventures through 'Our Recent Snaps.'
            Dive into a visual journey capturing breathtaking landscapes,
            heartwarming moments, and unforgettable experiences. From sun-kissed
            beaches to vibrant cityscapes, let our snapshots inspire your
            wanderlust and transport you to new horizons
          </p>
        </Zoom>
      </div>
